...
If you're using IntelliJ IDEA, you can add [this plugin](https://plugins.jetbrains.com/plugin/25044-stonecutter-dev) to make working with Stonecutter more convenient.